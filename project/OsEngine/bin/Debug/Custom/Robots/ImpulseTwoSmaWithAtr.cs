...
[Bot("ImpulseTwoSmaWithAtr")]
class ImpulseTwoSmaWithAtr : BotPanel
{
    BotTabSimple _tab;
    ...
    public ImpulseTwoSmaWithAtr(string name, StartProgram startProgram) : base(name, startProgram)
    {
