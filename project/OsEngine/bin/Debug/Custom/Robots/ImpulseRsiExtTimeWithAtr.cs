...
[Bot("ImpulseRsiExtTimeWithAtr")]
internal class ImpulseRsiExtTimeWithAtr : BotPanel
{
    BotTabSimple _tab;
    ...
    public ImpulseRsiExtTimeWithAtr(string name, StartProgram startProgram) : base(name, startProgram)
    {
    ...
    {
        return "ImpulseRsiExtTimeWithAtr";
    }
