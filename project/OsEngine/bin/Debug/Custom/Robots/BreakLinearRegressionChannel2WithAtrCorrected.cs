...
[Bot("BreakLinearRegressionChannel2WithAtrCorrected")]
public class BreakLinearRegressionChannel2WithAtrCorrected : BotPanel
{
    BotTabSimple _tab;
    ...
    public BreakLinearRegressionChannel2WithAtrCorrected(string name, StartProgram startProgram) : base(name, startProgram)
    {
    ...
    {
        return "BreakLinearRegressionChannel2WithAtrCorrected";
    }
