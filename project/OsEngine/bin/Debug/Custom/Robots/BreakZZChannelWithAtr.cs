...
[Bot("BreakZZChannelWithAtr")]
public class BreakZZChannelWithAtr : BotPanel
{
    BotTabSimple _tab;
    ...
    public BreakZZChannelWithAtr(string name, StartProgram startProgram) : base(name, startProgram)
    {
