...
[Bot("BreakLinearRegressionChannel2Corrected")]
public class BreakLinearRegressionChannel2Corrected : BotPanel
{
    BotTabSimple _tab;
    ...
    public BreakLinearRegressionChannel2Corrected(string name, StartProgram startProgram) : base(name, startProgram)
    {
    ...
    {
        return "BreakLinearRegressionChannel2Corrected";
    }
