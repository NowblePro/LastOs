...
{
    [Bot("TrailingImpulseHmaRsiWithAtrTm")]
    public class TrailingImpulseHmaRsiWithAtrTm : BotPanel
    {
        BotTabSimple _tab;
        ...
        private decimal _lastAtrFilter;
        ...
        public TrailingImpulseHmaRsiWithAtrTm(string name, StartProgram startProgram) : base(name, startProgram)
        {
        ...
        {
            return "TrailingImpulseHmaRsiWithAtrTm";
        }
