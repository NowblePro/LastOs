...
{
    [Bot("ParabolicSarClassicTradeWithAtrTm")]
    public class ParabolicSarClassicTradeWithAtrTm : BotPanel
    {
        ...
        public ParabolicSarClassicTradeWithAtrTm(string name, StartProgram startProgram) : base(name, startProgram)
        {
        ...
        {
            return "ParabolicSarClassicTradeWithAtrTm";
        }
