...
{
    [Bot("BreakLinearRegressionChannel2WithAtrCorrectedTm")]
    public class BreakLinearRegressionChannel2WithAtrCorrectedTm : BotPanel
    {
        BotTabSimple _tab;
        ...
        public BreakLinearRegressionChannel2WithAtrCorrectedTm(string name, StartProgram startProgram) : base(name, startProgram)
        {
        ...
        {
            return "BreakLinearRegressionChannel2WithAtrCorrectedTm";
        }
