...
{
    [Bot("BreakBBWithAtrTm")]
    public class BreakBBWithAtrTm : BotPanel
    {
        BotTabSimple _tab;
        ...
        public BreakBBWithAtrTm(string name, StartProgram startProgram) : base(name, startProgram)
        {
