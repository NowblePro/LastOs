...
{
    [Bot("BreakKeltnerChannelsWithAtrTm")]
    public class BreakKeltnerChannelsWithAtrTm : BotPanel
    {
        ...
        public BreakKeltnerChannelsWithAtrTm(string name, StartProgram startProgram) : base(name, startProgram)
        {
        ...
        {
            return "BreakKeltnerChannelsWithAtrTm";
        }
