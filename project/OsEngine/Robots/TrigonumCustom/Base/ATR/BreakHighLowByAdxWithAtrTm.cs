...
{
    [Bot("BreakHighLowByAdxWithAtrTm")]
    public class BreakHighLowByAdxWithAtrTm : BotPanel
    {
        ...
        public BreakHighLowByAdxWithAtrTm(string name, StartProgram startProgram)
        ...
        {
            return "BreakHighLowByAdxWithAtrTm";
        }
