...
{
    [Bot("ImpulseMoveLongBotExtTimeWithAtrTm")]
    public class ImpulseMoveLongBotExtTimeWithAtrTm : BotPanel
    {
        ...
        public ImpulseMoveLongBotExtTimeWithAtrTm(string name, StartProgram startProgram)
        ...
        {
            return "ImpulseMoveLongBotExtTimeWithAtrTm";
        }
        ...
        private void TryOpenPosition(List<Candle> candles)
        {
            ...
            if (priceEtalon + _tab.Securiti.PriceStep * 5 < candles[candles.Count - 1].Close && BuySignalIsFiltered(candles) != true)
            {
