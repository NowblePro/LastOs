...
namespace OsEngine.Robots.TrigonumCustom.Base
{
    ...
    [Bot("BreakLinearRegressionChannel2Rsi")]
    public class BreakLinearRegressionChannel2Rsi : BotPanel
    {
        BotTabSimple _tab;
        ...
        public BreakLinearRegressionChannel2Rsi(string name, StartProgram startProgram) : base(name, startProgram)
        {
            _name = name;
            ...
            {// enter logic
                    ...
                    && _lastPrice >= lr_down_short)
                {
                    ...
                    if (!SellSignalIsFiltered(candles))
                        _tab.SellAtStop(GetVolume(), lr_down_short - _slippage, lr_down_short, StopActivateType.LowerOrEqual, 1);
                }
            }
        ...
        {
            return "BreakLinearRegressionChannel2Rsi";
        }
