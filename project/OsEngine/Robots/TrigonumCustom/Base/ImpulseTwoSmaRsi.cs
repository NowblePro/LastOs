...
namespace OsEngine.Robots.TrigonumCustom.Base
{
    ...
    [Bot("ImpulseTwoSmaRsi")]
    class ImpulseTwoSmaRsi : BotPanel
    {
        BotTabSimple _tab;
        ...
        public ImpulseTwoSmaRsi(string name, StartProgram startProgram) : base(name, startProgram)
        {
