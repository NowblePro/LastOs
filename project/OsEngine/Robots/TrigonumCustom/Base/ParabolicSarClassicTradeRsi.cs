...
namespace OsEngine.Robots.TrigonumCustom.Base
{
    ...
    public class ParabolicSarClassicTradeRsi : BotPanel
    {
        ...
        public ParabolicSarClassicTradeRsi(string name, StartProgram startProgram) : base(name, startProgram)
        {
        ...
        {
            return "ParabolicSarClassicTradeRsi";
        }
            ...
            else
            {
                for (int i = 0; i < positions.Count; i++)
                {
                    ...
                    if (pos.Direction == Side.Buy)
                    {
                        ...
                        {
                            _tab.SellAtStopCancel();
                            _tab.SellAtStop(GetVolume(), priceOrder - _slippage, priceLine, StopActivateType.LowerOrEqual, 1);
                        }
