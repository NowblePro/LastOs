...
namespace OsEngine.Robots.TrigonumCustom.Channel
{
    ...
    [Bot("ReverseAdaptivePriceChannelPlus_2Rsi")]
    public class ReverseAdaptivePriceChannelPlus_2Rsi : BotPanel
    {
        ...
        public ReverseAdaptivePriceChannelPlus_2Rsi(string name, StartProgram startProgram) : base(name, startProgram)
        {
        ...
        {
            return "ReverseAdaptivePriceChannelPlus_2Rsi";
        }
