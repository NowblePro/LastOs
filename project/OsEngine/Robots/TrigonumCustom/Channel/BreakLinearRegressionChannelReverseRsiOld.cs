...
{
    [Bot("BreakLinearRegressionChannelReverseRsiOld")]
    public class BreakLinearRegressionChannelReverseRsiOld : BotPanel
    {
        ...
        public BreakLinearRegressionChannelReverseRsiOld(string name, StartProgram startProgram)
