...
{
    [Bot("BreakLinearRegressionChannelReverseRsiTM")]
    public class BreakLinearRegressionChannelReverseRsiTM : BotPanel
    {
        ...
        public BreakLinearRegressionChannelReverseRsiTM(string name, StartProgram startProgram)
        ...
        {
            return nameof(BreakLinearRegressionChannelReverseRsiTM);
        }
        ...
        private void _tab_CandleFinishedEvent(List<Candle> candles)
        {
            ...
            {
                if (_fixTpIsOn.ValueBool && !positions[0].ProfitOrderIsActiv)
                {
