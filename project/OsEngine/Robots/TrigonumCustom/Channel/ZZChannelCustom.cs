...
namespace OsEngine.Robots.TrigonumCustom.Channel
{
    ...
    public class ZZChannelCustom : BotPanel
    {
        ...
        private StrategyParameterInt _channelMeanPosition;
        ...
        public ZZChannelCustom(string name, StartProgram startProgram) : base(name, startProgram)
        {
            ...
            _channelMeanPosition = CreateParameter("Channel Mean Position", 2, 2, 3, 1, "Channel parameters");
        ...
        private void ZZCh_ParametrsChangeByUser()
        {
            ...
            _zz.ParametersDigit[4].Value = _channelMeanPosition.ValueInt;
            _zz.Save();
            _zz.Reload();
