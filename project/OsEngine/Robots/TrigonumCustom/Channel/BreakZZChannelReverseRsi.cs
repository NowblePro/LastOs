...
namespace OsEngine.Robots.TrigonumCustom.Channel
{
    ...
    [Bot("BreakZZChannelReverseRsi")]
    public class BreakZZChannelReverseRsi : BotPanel
    {
        ...
        public BreakZZChannelReverseRsi(string name, StartProgram startProgram) : base(name, startProgram)
        {
        ...
        {
            return "BreakZZChannelReverseRsi";
        }
